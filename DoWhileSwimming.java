...
public class DoWhileSwimming
{
	public static void main(String[] args) throws Exception
	{
		...
		// both have equal swim time for 80.5 temp
		// at 78 the while loop stops immediatly but the do while loops once before ending
		// Gallant checks first
		// a do while loop runs the loop before testing the condition whereas a while tests the condition before running the loop
